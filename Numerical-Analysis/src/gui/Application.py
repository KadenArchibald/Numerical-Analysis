...
requiredVersion = 8.5
assert tk.TkVersion >= requiredVersion, 'Update version of tkinter to 8.5'
...
class Application:
    def __init__(self):
        ...
        # Initialize
        self.root = tk.Tk()
        self.root.title("Numerical-Analysis")
        
        
        self.refreshRate = 60 # Hz
    ...
    def start(self):
        ...
        self.optimizePage = tk.ttk.Frame(self.notebook)
        self.calculusPage = tk.ttk.Frame(self.notebook)
        
        self.notebook.add(self.optimizePage, text = 'Optimization')
        self.notebook.add(self.calculusPage, text = 'Calculus')
        
        self.notebook.grid()
        self.addButton(self.calculusPage, 'test')
        
        self.createPlot('test', self.optimizePage)
    ...
    def addButton(self, targetFrame, buttonText, buttonFunction = None, yPos = 0, xPos = 0):
        
        # Add button
        button = tk.Button(targetFrame, text = buttonText)
        button.grid(column = xPos, row = yPos)
    
    
    def createPlot(self, name, location):
        ...
        text = ScrolledText(self.calculusPage)
        text.grid()
